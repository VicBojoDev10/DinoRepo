...
namespace Dino.Utility.Audio
{
    ...
    public class AudioManager : MonoBehaviour
    {
        ...
        [Header("BGM — deben ser hijos de este GameObject")]
        [SerializeField] private AudioSource bgmLobby;
        [SerializeField] private AudioSource bgmUpgrades;
        [SerializeField] private AudioSource bgmGameplay;
 
        [Header("SFX — Menús")]
        [SerializeField] private AudioClip sfxEnterMenu;
        [SerializeField] private AudioClip sfxBackMenu;
 
        [Header("SFX — Gameplay")]
        [SerializeField] private AudioClip sfxInitialHit;
